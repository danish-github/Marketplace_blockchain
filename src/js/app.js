App = {
      ...
      initContract: function() {
        $.getJSON('Marketplace.json', function(marketListArtifact) {
          // get the contract artifact file and use it to instantiate a truffle contract abstraction
          App.contracts.marketList = TruffleContract(marketListArtifact);
          // set the provider for our contracts
          App.contracts.marketList.setProvider(App.web3Provider);
          //listen to events
          App.listenToEvents();
      ...
      reloadArticles: function() {
        ...
        App.contracts.marketList.deployed().then(function(instance) {
