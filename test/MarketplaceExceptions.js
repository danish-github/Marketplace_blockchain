...
contract("Marketplace", function(accounts){
  ...
  it("should throw an exception if you try to buy an article when there is no article for sale yet", function() {
    ...
    .catch(function(error){
      ...
      return MarketplaceInstance.getArticle();
    }).then(function(data) {
  ...
  it("should throw an exception if you try to buy your own article", function() {
    return Marketplace.deployed().then(function(instance){
      ...
      return MarketplaceInstance.buyArticle({from: seller, value: web3.toWei(articlePrice, "ether")});
    }).then(assert.fail)
    .catch(function(error){
      assert(true);
    }).then(function() {
  ...
  it("should throw an exception if you try to buy an article for a value different from its price", function() {
    return Marketplace.deployed().then(function(instance){
      MarketplaceInstance = instance;
      return MarketplaceInstance.buyArticle({from: buyer, value: web3.toWei(articlePrice + 1, "ether")});
    }).then(assert.fail)
    .catch(function(error){
      assert(true);
    }).then(function() {
  ...
  it("should throw an exception if you try to buy an article that has already been sold", function() {
    return Marketplace.deployed().then(function(instance){
      MarketplaceInstance = instance;
      return MarketplaceInstance.buyArticle({from: buyer, value: web3.toWei(articlePrice, "ether")});
    }).then(function(){
      return MarketplaceInstance.buyArticle({from: buyer, value: web3.toWei(articlePrice, "ether")});
    }).then(assert.fail)
    .catch(function(error){
